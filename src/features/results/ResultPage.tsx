...
export function ResultPage() {
  ...
  return (
    <div className={styles.page}>
      <header className={styles.pageHeader}><p className={styles.eyebrow}>연습 결과 · 코칭 리포트</p><h1>합격 판정이 아닌,<br />다음 답변을 위한 기록</h1><p className={styles.lead}>{data?.summary ?? interview?.summary ?? "답변에서 실제로 관찰된 내용을 기준으로 정리했습니다."}</p></header>
