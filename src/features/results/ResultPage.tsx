...
export function ResultPage() {
  ...
  return (
    <div className={styles.page}>
      <header className={styles.pageHeader}><p className={styles.eyebrow}>R01</p><h1>결과 요약</h1><p className={styles.lead}>{data?.summary ?? interview?.summary ?? "답변에서 실제로 관찰된 내용을 기준으로 정리했습니다."}</p></header>
